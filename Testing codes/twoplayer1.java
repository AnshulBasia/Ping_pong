...
public class twoplayer1 extends JPanel implements ActionListener, KeyListener, Runnable{
    ...
    public void actionPerformed(ActionEvent e){
        if(startgamelocal && startgameforeign)
        {
    ...
    public void run()
    {
        ...
        while(running)
        {
            try
            {
                ...
                int temp1=Integer.parseInt(balldeltax);
                //int temp2=Integer.parseInt(balldeltax);
                ballDeltaX=-1*temp1;
                System.out.println("Ball DeltaX="+ballDeltaX);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        positionmsg=positionmsg+"-"+playerOneY;
        try
        {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////       
        ...
        if (nextBallLeft < playerOneRight) { 
            ...
            if ( ballY > playerOneBottom || ballY < playerOneTop) {
                ...
                positionballmsg=positionballmsg+playerOneX+"-"+playerOneY+"-"+ballDeltaX+"-"+ballDeltaY;
                //positionballmsg=positionballmsg+"-"+playerOneY;
                //positionballmsg=positionballmsg+"-"+ballDeltaX+"-"+ballDeltaY;
               /* try
                {
